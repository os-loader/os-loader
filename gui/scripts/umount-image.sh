...
for f in $sysmounts $imagedir/usb $imagedir.tmp/files/usb $imagedir/dev/pts $imagedir/dev $imagedir $imagedir.overlay.real $imagedir.overlay $imagedir.tmp $imagedir.live; do
  errignore
