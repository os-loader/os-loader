...
function script(sc,args,name,cb,ev2) {
  ...
  var p=spawn("/bin/bash",args,{
    env:{
      FNC:pth.join(pp,"fnc.sh"),
      image:config.currentImage,
      devmountpoint:(global.devmount?global.devmountpoint:""),
      devmount:(global.devmount?"true":""),
      isinstall:(global.install?"true":""),
      isnormal:(global.active?"true":""),
      isactive:(global.active?"true":""),
      isos:(isos?"true":""),
      isdev:(isdev?"true":""),
      imagedir:global.imagedir,
      usb:global.mountdir,
